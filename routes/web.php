...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::match(['post', 'put'], '/settings/update', [AdminController::class, 'updateProfile'])->name('settings.update');
    ...
    Route::post('/events/{id}/toggle', [AdminController::class, 'toggleAcademicEvent'])->name('events.toggle');
});
