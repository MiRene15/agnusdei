            ...
            <form method="POST" action="{{ route('student.admission.store') }}">
                ...
                <div style="margin-bottom:25px;">
                    ...
                    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap:18px;">
                        ...
                        <div><label style="display:block; margin-bottom:8px; font-weight:600; color:#334155;">Phone</label><input type="text" name="phone" value="{{ old('phone') }}" style="width:100%; padding:12px 14px; border:1px solid #cbd5e1; border-radius:10px;"></div>
                    </div>
                ...
                <div style="margin-bottom:25px;">
                    ...
                    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap:18px;">
                        ...
                        <div>
                            ...
                            <input type="text" name="lrn" id="lrn" value="{{ old('lrn') }}" maxlength="12" required disabled placeholder="Select grade first" style="width:100%; padding:12px 14px; border:1px solid #cbd5e1; border-radius:10px; background:#f8fafc;">
