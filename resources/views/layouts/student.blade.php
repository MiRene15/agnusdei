...
<div class="sidebar">
    <div class="brand-box"><h2>Student Portal</h2><p>Agnus Dei School Systems ERP</p></div>
    <div class="menu-label">Main Menu</div>
    <a href="{{ route('student.dashboard') }}" class="{{ request()->routeIs('student.dashboard') ? 'active' : '' }}">Dashboard</a>
    <a href="{{ route('student.subjects') }}" class="{{ request()->routeIs('student.subjects') ? 'active' : '' }}">Subjects</a>
    <a href="{{ route('student.schedule') }}" class="{{ request()->routeIs('student.schedule') ? 'active' : '' }}">Schedule</a>
    <a href="{{ route('student.grades') }}" class="{{ request()->routeIs('student.grades') ? 'active' : '' }}">Grades</a>
    <a href="{{ route('student.assessment') }}" class="{{ request()->routeIs('student.assessment') ? 'active' : '' }}">Assessment</a>
    <a href="{{ route('student.settings') }}" class="{{ request()->routeIs('student.settings*') ? 'active' : '' }}">Settings</a>
...
<div class="main">
    <div class="topbar"><h3>@yield('title', 'Student Dashboard')</h3><div class="welcome">Welcome, {{ Auth::user()->name ?? 'Student' }}</div></div>
