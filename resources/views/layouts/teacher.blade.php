...
<div class="sidebar">
    <div class="brand-box"><h2>Teacher Portal</h2><p>Agnus Dei School Systems ERP</p></div>
    <div class="menu-label">Main Menu</div>
    <a href="{{ route('teacher.dashboard') }}" class="{{ request()->routeIs('teacher.dashboard') ? 'active' : '' }}">Dashboard</a>
    <a href="{{ route('teacher.classes') }}" class="{{ request()->routeIs('teacher.classes*') ? 'active' : '' }}">Classes</a>
    <a href="{{ route('teacher.schedule') }}" class="{{ request()->routeIs('teacher.schedule*') ? 'active' : '' }}">Schedule</a>
    <a href="{{ route('teacher.grades') }}" class="{{ request()->routeIs('teacher.grades*') ? 'active' : '' }}">Grade Encoding</a>
    <a href="{{ route('teacher.reports') }}" class="{{ request()->routeIs('teacher.reports*') ? 'active' : '' }}">Reports</a>
    <a href="{{ route('teacher.settings') }}" class="{{ request()->routeIs('teacher.settings*') ? 'active' : '' }}">Settings</a>
...
<div class="main">
    <div class="topbar"><h3>@yield('title', 'Teacher Dashboard')</h3><div class="welcome">Welcome, {{ Auth::user()->name ?? 'Teacher' }}</div></div>
...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        sanitizeNumericInputs(document);
        bindLoadingScreen();
    });
})();
</script>
