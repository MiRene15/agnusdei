...
<div class="sidebar">
    <div class="brand-box"><h2>Parent Portal</h2><p>Agnus Dei School Systems ERP</p></div>
    <div class="menu-label">Main Menu</div>
    <a href="{{ route('parent.dashboard') }}" class="{{ request()->routeIs('parent.dashboard') ? 'active' : '' }}">Dashboard</a>
    <a href="{{ route('parent.children') }}" class="{{ request()->routeIs('parent.children') ? 'active' : '' }}">My Children</a>
    <a href="{{ route('parent.grades') }}" class="{{ request()->routeIs('parent.grades') ? 'active' : '' }}">Grades</a>
    <a href="{{ route('parent.billing') }}" class="{{ request()->routeIs('parent.billing') ? 'active' : '' }}">Billing</a>
    <a href="{{ route('parent.settings') }}" class="{{ request()->routeIs('parent.settings*') ? 'active' : '' }}">Settings</a>
...
<div class="main">
    <div class="topbar"><h3>@yield('title', 'Parent Dashboard')</h3><div class="welcome">Welcome, {{ Auth::user()->name ?? 'Parent' }}</div></div>
