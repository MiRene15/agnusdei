...
<div class="sidebar">
    <div class="brand-box"><h2>Admin Portal</h2><p>Agnus Dei School Systems ERP</p></div>
    ...
    <a href="{{ route('admin.reference-codes') }}" class="{{ request()->routeIs('admin.reference-codes*') ? 'active' : '' }}">Reference Codes</a>
...
<div class="main">
    <div class="topbar"><h3>@yield('title', 'Admin Dashboard')</h3><div class="welcome">Welcome, {{ Auth::user()->name ?? 'Admin' }}</div></div>
    <div class="content">
        @if(session('success'))
